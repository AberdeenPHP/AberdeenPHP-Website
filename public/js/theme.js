...
window.addEventListener('load', function () {
    document.body.addEventListener('click', function (event) {
        ...
        if (event.target.tagName.toLowerCase() === 'img' && event.target.classList.contains('btk-lightbox-img') || event.target.parentNode.id === 'btk-lightbox-overlay') {
            var wrapper = document.querySelector('#btk-lightbox-overlay');
            ...
            var image = event.target.dataset.btkImg;
...
__webpack_require__("./resources/js/btkLightbox.js");
