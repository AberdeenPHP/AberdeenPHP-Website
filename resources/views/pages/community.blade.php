        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            ...
            <ul>
                <li>
                    ...
                    is a monthly excuse for developers and the tech community around Scotland 
                    to meet up and learn new stuff from each other.   
                </li>
                <li>
                    ...
                    is a hacker collective with a shared space (known as the hacklab, hackspace, hackerspace, or 
                    simply just the space). They meet every Tuesday and non-members are welcome.
                </li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="http://dundeephp.co.uk/">DundeePHP</a>: Dundee PHP user group meet on the fourth 
                    Tuesday each month.
                </li>
                <li>
